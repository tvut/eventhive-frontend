<script>
    ...
    // Check initial RSVP status for the event
...
<div on:click={() => { popup = !popup }} style="background-color: {getBg(event.category)};" class="cursor-pointer text-white rounded-xl p-4 my-2 flex justify-between items-center">
    <div>
    ...
    <div class="flex items-center">
        ...
        >
            <i class="fa-sharp fa-solid fa-heart text-2xl" style="color: {isRSVPed ? 'lightpink' : 'darkpink'};"></i>
        </button>
    </div>
</div>
